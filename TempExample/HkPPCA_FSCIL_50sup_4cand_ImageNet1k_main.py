...
def HkPPCAs(num_labeled_per_class, q_ini, q_train, lda, num_iters, dataset_name, self_learner_name, feature_address,
    ...
    for session_id in range(num_sessions):
        ...
        norm_name = 'HkPPCAs_{}_run{}_base_Normalization_{}.pth'.format(
        ...
        ## Task: Recall stored classes from previous sessions and save to mu_ini, L_ini, S_ini, and nc
        if session_id > 0:
            ...
            cov_prestored= prestored_result['cov_online']
            ...
            cov_ini[:num_prestored_cls] = cov_prestored
        ...
        for iter_id in range(num_iters):
            ...
            for batch_id, data in enumerate(train_loader):
                ...
                for obs1_id in range(n_one_batch):
                    ...
                    if score_obs1_mincls>=num_prestored_cls and score_obs1[score_obs1_minid] < score_criteria[score_obs1_mincls]:  # if not, out of distribution, throw away
...
if __name__ == '__main__':
    ...
    # runs_seeds_list = [[5],
    #                    ]
    # sessions_list = [[0, 1000]] # tag: not incremental
