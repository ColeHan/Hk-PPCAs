...
if __name__=='__main__':
    ...
    for j in range(4563, nc):
        ...
        if train:
            ...
            name = 'K:/LargeDataset/imagenet21k_resized/features_train_augmented2x_ImageNet10k_288_resnetx4_CLIP/%s.mat' % (names[j])
            ...
            name = 'K:/LargeDataset/imagenet21k_resized/features_val_augmented2x_ImageNet10k_288_resnetx4_CLIP/%s.mat' % (names[j])
